...
// ]];
  ...
  function predictImage(){
    ...
    //   console.log(`dtype of Tensor: ${X.dtype}`);
      let predictNum = model.predict(X);
    //   console.log(`written number is: ${number}`);
      let num = predictNum.dataSync()[0]
      console.log(num);
